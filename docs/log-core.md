...
- Final live matrix on the same 40 questions: E1 fixed/vector `Recall@5 62.5%`, `Recall@10 65.0%`, `MRR 46.0%`; E2 structural/vector `80.0%`, `85.0%`, `65.4%`; E3 structural/hybrid `80.0%`, `87.5%`, `61.2%`.
